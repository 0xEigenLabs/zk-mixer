...
exports.proofIdx = exports.idxToBinaryPos = exports.binaryPosToIdx = exports.getBase2Log = exports.generateMerkleProofArray = exports.generateMerklePosArray = exports.pairwiseHash = exports.rootFromLeafArray = exports.treeFromLeafArray = exports.padLeafHashArray = exports.padLeafArray = exports.rootFromLeafAndPath = exports.verifyProof = exports.getProof = exports.getRoot = exports.getLeaf = exports.updateTree = exports.insert = exports.init = void 0;
...
const getProof = function (leafIdx, tree, leaves) {
...
const verifyProof = function (leaf, idx, proof, root) {
    let computed_root = module.exports.rootFromLeafAndPath(leaf, idx, proof);
    return (root == computed_root);
};
exports.verifyProof = verifyProof;
const rootFromLeafAndPath = function (leaf, idx, merkle_path) {
...
exports.rootFromLeafAndPath = rootFromLeafAndPath;
// fill a leaf array with zero leaves until it is a power of 2
const padLeafArray = function (leafArray, zeroLeaf, fillerLength) {
...
exports.padLeafArray = padLeafArray;
// fill a leaf hash array with zero leaf hashes until it is a power of 2
const padLeafHashArray = function (leafHashArray, zeroLeafHash, fillerLength) {
...
exports.padLeafHashArray = padLeafHashArray;
const treeFromLeafArray = function (leafArray) {
...
exports.treeFromLeafArray = treeFromLeafArray;
const rootFromLeafArray = function (leafArray) {
    return module.exports.treeFromLeafArray(leafArray)[0][0];
};
exports.rootFromLeafArray = rootFromLeafArray;
const pairwiseHash = function (array) {
    if (array.length % 2 == 0) {
        let arrayHash = [];
        for (var i = 0; i < array.length; i = i + 2) {
            arrayHash.push(mimcjs.hash(array[i].toString(), array[i + 1].toString()));
        }
        return arrayHash;
    }
    else {
...
exports.pairwiseHash = pairwiseHash;
const generateMerklePosArray = function (depth) {
    let merklePosArray = [];
...
exports.generateMerklePosArray = generateMerklePosArray;
const generateMerkleProofArray = function (txTree, txLeafHashes) {
...
exports.generateMerkleProofArray = generateMerkleProofArray;
///////////////////////////////////////////////////////////////////////
// HELPER FUNCTIONS
///////////////////////////////////////////////////////////////////////
const getBase2Log = function (y) {
    return Math.log(y) / Math.log(2);
};
exports.getBase2Log = getBase2Log;
const binaryPosToIdx = function (binaryPos) {
    var idx = 0;
...
exports.binaryPosToIdx = binaryPosToIdx;
const idxToBinaryPos = function (idx, binLength) {
...
exports.idxToBinaryPos = idxToBinaryPos;
const proofIdx = function (leafIdx, treeDepth) {
